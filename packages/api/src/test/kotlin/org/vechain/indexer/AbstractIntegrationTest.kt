...
abstract class AbstractIntegrationTest {
    ...
    protected val LIST_PAGINATED_TX_TYPE = object : TypeReference<PaginatedResponse<List<IndexedTransaction>>>() {}
    ...
    protected val CONTRACT_PAGINATED_TYPE = object : TypeReference<PaginatedResponse<List<IndexedContract>>>() {}
    protected val LIST_NFT_TYPE = object : TypeReference<List<IndexedNFT>>() {}
    protected val LIST_PAGINATED_NFT_TYPE = object : TypeReference<PaginatedResponse<List<IndexedNFT>>>() {}
    ...
    protected val LIST_PAGINATED_TRANSFER_EVENT_TYPE =
        object : TypeReference<PaginatedResponse<List<IndexedTransferEvent>>>() {}
    protected val LIST_CLAUSE_TYPE = object : TypeReference<List<IndexedClause>>() {}
    protected val LIST_PAGINATED_CLAUSE_TYPE = object : TypeReference<PaginatedResponse<List<IndexedClause>>>() {}
