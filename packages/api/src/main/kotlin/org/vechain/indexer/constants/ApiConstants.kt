...
const val VALIDATORS_PATH = "$API_PATH/validators"
const val VALIDATORS_PATH_V2 = "$API_ROOT/v2/validators"
const val B3TR_PATH = "$API_PATH/b3tr"
const val B3TR_PATH_V2 = "$API_ROOT/v2/b3tr"
const val GM_NFT_PATH = "$B3TR_PATH/galaxy-members"
const val X_ALLOC_PATH = "$B3TR_PATH/xallocations"
const val TREASURY_PATH = "$B3TR_PATH/treasury"
const val NAVIGATOR_PATH = "$B3TR_PATH/navigators"
const val CHALLENGES_PATH = "$B3TR_PATH/challenges"
const val WALLET_CHALLENGES_PATH = "$B3TR_PATH/users/{wallet}/challenges"
