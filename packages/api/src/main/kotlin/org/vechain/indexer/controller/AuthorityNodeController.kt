...
import org.vechain.indexer.service.AuthorityNodeQueryService
...
open class AuthorityNodeController(
    private val authorityNodeQueryService: AuthorityNodeQueryService
) {
    ...
    open fun checkUserIsEndorser(
        ...
        return authorityNodeQueryService.checkUserIsEndorser(user.value)
    }
}
