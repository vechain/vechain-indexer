...
object VeWorldAPIClient {
    ...
    private val PAGINATED_CLAUSE_TYPE = object : ParameterizedTypeReference<PaginatedResponse<List<IndexedClause>>>() {}
    private val TX_TYPE = object : ParameterizedTypeReference<IndexedTransaction>() {}
    private val PAGINATED_TX_TYPE =
        object : ParameterizedTypeReference<PaginatedResponse<List<IndexedTransaction>>>() {}
    private val CONTRACT_TYPE = object : ParameterizedTypeReference<IndexedContract>() {}
    private val PAGINATED_CONTRACT_TYPE =
        object : ParameterizedTypeReference<PaginatedResponse<List<IndexedContract>>>() {}
    ...
    private val PAGINATED_TRANSFER_EVENT_TYPE =
        object : ParameterizedTypeReference<PaginatedResponse<List<IndexedTransferEvent>>>() {}
    ...
    ): PaginatedResponse<List<IndexedContract>> {
    ...
    fun getTransactionsByOrigin(
        ...
        page: Int = 0,
        size: Int = Int.MAX_VALUE
    ): PaginatedResponse<List<IndexedTransaction>> {
        return getRequest(
