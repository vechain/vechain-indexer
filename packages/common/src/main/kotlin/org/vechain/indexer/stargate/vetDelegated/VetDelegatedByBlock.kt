...
) : TimeFrameDocument, LevelledValue<BigInteger>, VersionedDocument {
...
@Document(collection = "stargate_total_vet_delegated_by_block_archives")
data class VetDelegatedByBlockArchive(
    @Id override val id: String,
    override val data: VetDelegatedByBlock,
) : Archive<VetDelegatedByBlock>
