 ...
 *   validator hasn't started, or a terminal [DelegationStatusV2.EXITED]).
 * - [status] uses [DelegationStatusV2] (no `NONE` — a delegation always has a definite state) to
 *   keep V2 isolated from V1's [Status] enum.
 *
 * The V1 [Delegation.totalRewardsClaimed] semantics carry over unchanged.
 */
@Document(collection = IndexerNames.DELEGATION_V2.COLLECTION)
@JsonInclude(JsonInclude.Include.NON_NULL)
data class DelegationV2(
    @Id val id: String,
