...
@Repository
open class PostgresVthoClaimedByBlockRepository(private val jdbcTemplate: JdbcTemplate) :
    VthoClaimedByBlockRepository {

    private val tableName = "stargate_vtho_claimed_by_block"

    override fun saveAll(records: Iterable<VthoClaimedByBlock>): Iterable<VthoClaimedByBlock> {
        ...
        jdbcTemplate.batchUpdate(
            ...
            INSERT INTO $tableName (
                ...
                day_total, week_total, month_total, year_total, total, legacy_rewards
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?::text[], ?, ?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT (block_number) DO UPDATE SET
                ...
                legacy_rewards = EXCLUDED.legacy_rewards
            """
                .trimIndent(),
    ...
    private fun mapRow(rs: ResultSet): VthoClaimedByBlock {
        ...
        return VthoClaimedByBlock(
            ...
            legacyRewards = BigInteger(rs.getString("legacy_rewards")),
