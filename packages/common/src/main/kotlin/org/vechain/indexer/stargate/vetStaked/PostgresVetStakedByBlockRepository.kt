...
@Repository
open class PostgresVetStakedByBlockRepository(
    private val jdbcTemplate: JdbcTemplate,
    private val objectMapper: ObjectMapper,
) : VetStakedByBlockRepository {

    private val tableName = "stargate_total_vet_staked_by_block"

    override fun saveAll(records: Iterable<VetStakedByBlock>): Iterable<VetStakedByBlock> {
    ...
    private fun mapRow(rs: ResultSet): VetStakedByBlock {
