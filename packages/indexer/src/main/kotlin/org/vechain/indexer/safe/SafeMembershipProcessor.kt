...
@Profile("safe")
@Component
open class SafeMembershipProcessor(
    private val service: SafeMembershipService,
    repository: SafeMembershipRepository,
    ...
    BaseStatefulProcessor(
        ...
        checkpointService = checkpointService,
        collectionName = IndexerNames.SAFE_MEMBERSHIP.COLLECTION,
        processorMetrics = processorMetrics,
    ) {
