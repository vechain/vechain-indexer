...
@Profile("safe")
@Component
open class SafeTxProposalProcessor(
    private val service: SafeTxProposalService,
    repository: SafeTxProposalRepository,
    ...
    BaseStatefulProcessor(
        ...
        checkpointService = checkpointService,
        collectionName = IndexerNames.SAFE_TX_PROPOSAL.COLLECTION,
        processorMetrics = processorMetrics,
    ) {
