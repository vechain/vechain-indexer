...
data class ERC1155Contract(
    ...
    companion object {
        ...
        val SAFE_TRANSFER_FROM_FUNCTION_SIGNATURE =
            ContractUtils.getFunctionSignature("safeTransferFrom(address,address,uint256,uint256,bytes)")

        /**
         * function safeBatchTransferFrom(address _from, address _to, uint256[] _ids, uint256[] _values, bytes _data) external;
         */
        val SAFE_BATCH_TRANSFER_FROM_FUNCTION_SIGNATURE =
            ContractUtils.getFunctionSignature("safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)")
         ...
         */
        val SUPPORTS_INTERFACE_FUNCTION_SIGNATURE =
