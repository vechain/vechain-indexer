...
open class NavigatorDelegationEventConfig {

    @Bean
    open fun navigatorDelegationEventIndexer(
        thorClient: ThorClient,
        processor: NavigatorDelegationEventProcessor,
        ...
        IndexerFactory()
            .name(IndexerNames.NAVIGATOR_DELEGATION_EVENT.NAME)
            .thorClient(thorClient)
            .processor(processor)
