...
data class VIP210Contract(
    ...
    companion object {
        ...
        /**
         * function safeTransferFrom(address _from, address _to, uint256 _id, uint256 _value, string _data) external;
         */
        ...
        /**
         * function safeBatchTransferFrom(address _from, address _to, uint256[] _ids, uint256[] _values, string _data) external;
         */
