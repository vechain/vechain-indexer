...
object ValidatorAssembler {
    ...
    fun buildValidator(
        ...
        return Validator(
            ...
            vetStaked = NumberUtils.toSafeDecimal(stakes.totalVET),
            validatorVetStaked = NumberUtils.toSafeDecimal(stakes.validatorVET),
            delegatorVetStaked = NumberUtils.toSafeDecimal(stakes.delegatorVET),
            queuedVetStaked = NumberUtils.toSafeDecimal(stakes.queuedStake),
            validatorQueuedVetStaked = NumberUtils.toSafeDecimal(stakes.queuedValidatorVetStaked),
            delegatorQueuedVetStaked = NumberUtils.toSafeDecimal(stakes.queuedDelegationVetStaked),
            validatorExitingVetStaked = NumberUtils.toSafeDecimal(stakes.exitingValidatorVetStaked),
            delegatorExitingVetStaked =
                NumberUtils.toSafeDecimal(stakes.exitingDelegationVetStaked),
            exitingVetStaked = NumberUtils.toSafeDecimal(stakes.exitingStake),
            totalWeight = NumberUtils.toSafeDecimal(NumberUtils.toVET(row.validatorLockedWeight)),
            blockProbability = NumberUtils.toSafeDecimal(probabilities.blockProbability),
            blocksPerEpoch =
                NumberUtils.toSafeDecimal(probabilities.blockProbability * BigDecimal(180)),
            blocksPerYear = NumberUtils.toSafeDecimal(probabilities.blocksPerYear),
            validatorTvl = NumberUtils.toSafeDecimal(tvl.validatorTvl),
            delegatorTvl = NumberUtils.toSafeDecimal(tvl.delegatorTvl),
            totalTvl = NumberUtils.toSafeDecimal(tvl.totalTvl),
            validatorYield = NumberUtils.toSafeDecimal(validatorYield),
            tvlBasedYield = NumberUtils.toSafeDecimal(tvlBasedYield),
            avgDelegatorYield = NumberUtils.toSafeDecimal(avgDelegatorYield),
            nextCycleValidatorYield = NumberUtils.toSafeDecimal(nextCycleValidatorYield),
            nextCycleTvlBasedYield = NumberUtils.toSafeDecimal(nextCycleTvlBasedYield),
            nextCycleAvgDelegatorYield = NumberUtils.toSafeDecimal(nextCycleAvgDelegatorYield),
            nftYieldsNextCycle =
            ...
            percentageOffline = NumberUtils.toSafeDecimal(offline.percentageOffline),
