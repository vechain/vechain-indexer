...
open class NavigatorFeeSummaryConfig {
    @Bean
    open fun navigatorFeeSummaryIndexer(
        thorClient: ThorClient,
        processor: NavigatorFeeSummaryProcessor,
        ...
        IndexerFactory()
            .name(IndexerNames.NAVIGATOR_FEE_SUMMARY.NAME)
            .thorClient(thorClient)
            .processor(processor)
