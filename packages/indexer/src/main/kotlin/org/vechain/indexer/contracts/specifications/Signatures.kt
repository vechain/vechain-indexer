...
object Signatures {
    ...
    object SemiFungible {
        ...
        val BALANCE_OF_FUNCTION = ContractUtils.getFunctionSignature("balanceOf(address,uint256)")

        /**
         * function balanceOfBatch(address[] _owners, uint256[] _ids) external view returns
         * (uint256[] memory);
         */
