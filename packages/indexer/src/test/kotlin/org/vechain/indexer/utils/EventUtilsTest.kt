        ...
        fun `determineEventType should detect known types`() {
            val cases =
                mapOf(
                    ...
                    "B3MO_QUEST_CREATED" to HistoryEventName.B3MO_QUEST_CREATED,
                    "B3MO_QUEST_JOINED" to HistoryEventName.B3MO_QUEST_JOINED,
                    "B3MO_QUEST_JOINED_STAKE" to HistoryEventName.B3MO_QUEST_JOINED,
                    "B3MO_QUEST_REWARD_CLAIMED" to HistoryEventName.B3MO_QUEST_REWARD_CLAIMED,
                    "B3MO_QUEST_SPLIT_WIN_REWARD_CLAIMED" to
                        HistoryEventName.B3MO_QUEST_REWARD_CLAIMED,
                    "B3MO_QUEST_REFUND_CLAIMED" to HistoryEventName.B3MO_QUEST_REFUND_CLAIMED,
                    "B3MO_QUEST_CREATOR_REFUNDED" to HistoryEventName.B3MO_QUEST_CREATOR_REFUNDED,
                    "B3MO_QUEST_LEFT" to HistoryEventName.B3MO_QUEST_LEFT,
                    "B3MO_QUEST_CANCELLED" to HistoryEventName.B3MO_QUEST_CANCELLED,
                    "B3MO_QUEST_DECLINED" to HistoryEventName.B3MO_QUEST_DECLINED,
                    "B3MO_QUEST_COMPLETED" to HistoryEventName.B3MO_QUEST_COMPLETED,
