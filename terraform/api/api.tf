...
module "waf" {
  ...
  source = "git::git@github.com:/vechain/terraform_infrastructure_modules.git//waf?ref="git::git@github.com:/vechain/terraform_infrastructure_modules.git//waf?ref=waf_indexer_fix"
