# Pull in production environment settings from YAML configuration file
# This file reads ../environments/prod.yml directly (no workspace dependency)
...
locals {
  # Load the production environment configuration directly from YAML
