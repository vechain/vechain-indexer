...
echo "1. Testing 1-hour NFT holders (endpoint sends max-age=600):"
...
echo "6. Testing B3TR Apps Overview (endpoint sends max-age=3600):"
...
echo "7. Testing B3TR Galaxy Members Overview (endpoint sends max-age=3600):"
...
echo "8. Testing Stargate Total VTHO Claimed Historic (endpoint sends max-age=600):"
...
echo "9. Testing Stargate Total VET Staked Historic (endpoint sends max-age=600):"
